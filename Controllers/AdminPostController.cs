...
public class AdminPostController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("Title,Content,CategoryId,ThumbnailUrl,Excerpt,IsPublished")] Post post, IFormFile thumbnailFile)
    {
    ...
    public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Content,CategoryId,ThumbnailUrl,Excerpt,IsPublished")] Post post, IFormFile thumbnailFile)
    {
