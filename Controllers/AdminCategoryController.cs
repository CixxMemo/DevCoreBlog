...
//   - Categories with associated posts cannot be deleted (relationship protection)
...
public class AdminCategoryController : Controller
{
        ...
        [Bind("Id,Name")] CategoryFormInput input)
    {
        ...
        input.Slug = existingCategory.Slug;
        return View(input);
    }
    ...
    // If posts exist, deletion is blocked to prevent data loss.
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Delete(int id)
    {
        // Delegate to service layer — business logic (relationship protection)
